...
public class ScoringFilterException extends Exception {
  ...
  public ScoringFilterException(String message) {
    ...
    System.out.println("error running link based algo! recheck data");
  }

  public ScoringFilterException(String message, Throwable cause) {
	  System.out.println("error running link based algo! recheck data. casued by "+cause);
  }

  public ScoringFilterException(Throwable cause) {
	  System.out.println("error running link based algo! recheck data. caused by "+cause);
  }
